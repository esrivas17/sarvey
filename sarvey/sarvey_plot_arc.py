...
def main():
    ...
    resphase = demerr * point_obj.ifg_net_obj.tbase
    axes[1, 0].plot(point_obj.ifg_net_obj.tbase, np.angle(resphase))
   ...
   # axes[0, 2].set_title('Phase (Temperature)', fontsize=12)
    ...
    axes[1, 2].plot(tb_ifg, np.angle(np.exp(1j * resphase)))
