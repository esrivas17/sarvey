...
def computeIfgs_And_UnevenTemporalCoherence(*, path_temp_coh: str, path_ifgs: str, path_slc: str, ifg_array: np.ndarray,
...
def computeIfgsStack(*, path_ifgs: str, path_slc: str, ifg_array: np.ndarray,
    ...
    Compute the interferograms from the SLC stack for a given set of (spatial) patches.
