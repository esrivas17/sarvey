...
def exportDataToGisFormat(*, file_path: str, output_path: str, input_path: str,
    ...
    df_points.insert(2, 'amplitude', amplitude * 1000)
    df_points.insert(3, 'offset', offset)
    df_points.insert(4, 'coherence', coherence)
    df_points.insert(5, 'omega', omega)
    df_points.insert(6, 'st_consistency', stc * 1000)  # in [mm]
    df_points.insert(7, 'dem_error', demerr)  # in [m]
    df_points.insert(8, 'dem', point_obj.height)  # in [m]
