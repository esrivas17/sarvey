...
def main():
    ...
    print(f"Pre-excavation    -> DEM error: {demerr_pre:.2f} m, velocity: {vel_pre*1000:.2f} mm/yr, gamma: {gamma_pre:.2f}")
    print(f"Excavation        -> DEM error: {demerr_exca:.2f} m, velocity: {vel_exca*1000:.2f} mm/yr, gamma: {gamma_exca:.2f}")
