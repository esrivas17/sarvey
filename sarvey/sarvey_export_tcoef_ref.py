...
def exportDataToGisFormat(*, file_path: str, output_path: str, input_path: str, ref: list,
    ...
    offset = np.zeros_like(tcoef, dtype=np.float32)
    ...
    df_points.insert(7, 'omega', omega)
    df_points.insert(8, 'st_consistency', stc * 1000)  # in [mm]
    df_points.insert(9, 'dem_error', demerr)  # in [m]
    df_points.insert(10, 'dem', point_obj.height)  # in [m]
...
def createParser():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""EXAMPLE:
        sarvey_export outputs/p2_coh50_ts.h5 -o outputs/shp/p2_coh50.gpkg  --ref 121.404462499 25.01714041     # export time series to shapefile
